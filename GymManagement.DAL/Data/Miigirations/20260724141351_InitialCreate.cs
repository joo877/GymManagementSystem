        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCkeck", "Email like '_%@_%._%'");
                    table.CheckConstraint("PhoneCkeck", "Phone like '010%' or Phone like '011%' or Phone like '012%' or Phone like '015%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("EmailCkeck1", "Email like '_%@_%._%'");
                    table.CheckConstraint("PhoneCkeck1", "Phone like '010%' or Phone like '011%' or Phone like '012%' or Phone like '015%' ");
                });
